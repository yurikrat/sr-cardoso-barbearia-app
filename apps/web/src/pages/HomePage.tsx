...
export default function HomePage() {
  return (
    <div className="min-h-[100dvh] bg-background flex flex-col items-center justify-center p-4 safe-top-p4 safe-bottom-p4 bg-[url('https://www.transparenttextures.com/patterns/dark-leather.png')] md:bg-fixed overflow-x-hidden">
